...
to the value of its corresponding original node. Both the next and random pointer of the new nodes should point to new nodes in the
 copied list such that the pointers in the original list and copied list represent the same list state. None of the pointers in the 
...
var copyRandomList = function (head) {
    ...
    let curr = head;
    //inserting new Nodes between the nodes
    while (curr != null) {
        let temp = curr.next;
